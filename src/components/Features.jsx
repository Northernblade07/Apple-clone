        ...
        <div className='flex-col justify-center items-center flex'>
            ...
            <div className='flex-center flex-col sm:px-10 '>
                <div className='relative h-[50vh] w-full flex items-center'>
                    <video ref={VideoRef} autoPlay muted playsInline id='exploreVideo' className='w-full h-full object-center' preload='none' >
                ...
                <div className='flex flex-col w-full relative'>
                    ...
                    <div className=' feature-text-container'>
                        ...
                        <div className='flex-1 flex-center '>
                            <p className='feature-text g_text'> Titanium has one of the best strength-to-weight ratios of any meatal,making these our{' '}
                            <span className='text-white '>
